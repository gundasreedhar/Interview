...
public class InputOutputProcesser {
	...
	public static void main(String[] args) {
		InputOutputProcesser inputOutputProcesser = new InputOutputProcesser();
		inputOutputProcesser.messageSender();
	}
	...
	public void messageSender() {
		...
		senderKingdom = messageSender(kingdomMappings, senderKingdom);
		senderKingdom.findRulerAndAllies();
		isSoutherosKing(kingdomMappings);
	}

	public Kingdom getSenderKingdom(Map<String, Kingdom> kingdomMappings) {
		return kingdomMappings.get(ApplicationConstants.SPACE);
	}

	public Map<String, Kingdom> getProperKingDomMappings(Map<String, Map<String, Kingdom>> universekingdomMappings) {
		return universekingdomMappings.get(ApplicationConstants.SOUTHEROS);
	}

	public Map<String, Map<String, Kingdom>> loadKingdomData() {
	...
	public Kingdom messageSender(Map<String, Kingdom> kingdomMappings, Kingdom senderKingdom) {
	...
	public void isSoutherosKing(Map<String, Kingdom> kingdomMappings) {
