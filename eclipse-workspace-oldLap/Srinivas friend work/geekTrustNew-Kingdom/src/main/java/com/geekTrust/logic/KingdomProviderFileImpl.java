...
public class KingdomProviderFileImpl {
	...
	private Map<String, Map<String, Kingdom>> loadKingdoms(List<String> universeList) {
		Map<String, Map<String, Kingdom>> universeKingdomMap = new HashMap<String, Map<String, Kingdom>>();
		Map<String, Kingdom> kingdomMap = new HashMap<String, Kingdom>();
		for (String universe : universeList) {
			Properties properties = new Properties();
			try {
				InputStream inputStream = KingdomProviderFileImpl.class.getClassLoader()
